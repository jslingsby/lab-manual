...
* __Are mindful of our own biases - and agree to avoid being defensive when our unconscious biases are pointed out to us__
...
**Ask for help, and share your learning:** We are all learners, and most of our learning is done from each other. It is inefficient to struggle through problems alone. Ask for and give assistance with appropriate cognizance of the value of your time and the time of the person you are asking. You are not the first or last person to encounter a problem. When you identify a problem add an issue to the [lab issues repository](https://github.com/PlantEcologi/lab-chat/), and update it with solutions when it is resolved. If you can't access the repo, ask Jasper to add you... For bigger issues we can also consider adding to the lab manual, writing a tutorial/blog post for [lab’s web page](https://www.plantecolo.gy), and share with the larger community by tweeting, leading and sharing at a lab meeting, or running a workshop.  
...
**Foster inclusivity within our group and greater community:** Part of our lab culture is that we are good citizens of our community, we take on leadership roles within our Department and the University, we are supportive of others in our community during their milestones, we actively participate in Departmental events (e.g. the research symposium) and perform outreach. Work with Jasper when crafting your individual mentoring/development plans (see Chapter on Onboarding(in prep)) to identify what you want to aim your efforts at.  
